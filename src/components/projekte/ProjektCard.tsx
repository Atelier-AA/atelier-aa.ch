...
export default function ProjektCard({ projekt, priority = false }: ProjektCardProps) {
  return (
    ...
    >
      ...
      <h3 className="mt-5 text-[1.5rem] md:text-[1.85rem] lg:text-[2rem] xl:text-[2.25rem] font-light leading-tight text-ink transition-colors group-hover:text-graphite">
        {projekt.title}
      </h3>
