...
/**
 * Keine periodisch eingestreute Kontakt-Kachel mehr im Raster: zu viele
 * Conversion-Unterbrechungen zwischen den Projekten. Die Projekte sollen
 * ungestört im Vordergrund stehen, ein einziger CTA am Seitenende reicht.
 */
