          ...
          <ul className="flex flex-wrap items-center gap-x-6 gap-y-2">
            <li className="flex gap-3">
              <a
                ...
                className="flex h-7 w-7 items-center justify-center rounded-full bg-white/10 text-white/75 transition-colors duration-300 hover:bg-white hover:text-ink"
              >
