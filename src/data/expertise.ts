...
export const expertiseFragen: InsightFrage[] = [
  {
    ...
    antwort:
      'Architektur und Entwurf, Umbau und Sanierung, Projektentwicklung sowie Bauleitung: von der Machbarkeitsstudie über das Baugesuch bis zur Übergabe. Wir arbeiten nach der Ordnung SIA 102 und deren Leistungsphasen — Strategische Planung, Vorstudien, Projektierung, Ausschreibung und Realisierung. Diese Phasen können Sie einzeln oder zusammen beauftragen; üblich ist der Einstieg mit Vorstudie und Vorprojekt.',
  },
  {
    gruppe: 'machbarkeit',
