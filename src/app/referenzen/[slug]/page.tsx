    ...
    <>
      ...
      */}
      <div className="flex flex-col pt-[5.4rem] md:pt-[6.3rem] lg:flex-row lg:items-start">
        ...
        <div className="order-1 w-full px-6 pb-12 md:px-10 md:pb-16 lg:order-2 lg:sticky lg:top-28 lg:w-2/5 lg:px-16 lg:pb-28">
          ...
          <div className="mt-0 grid grid-cols-1 gap-12 border-t border-mist pt-12 sm:grid-cols-2">
            <div>
