      ...
      <div className="pt-24 md:pt-28">
        <Container>
          <div className="mb-10 bg-ink px-6 py-3 text-center text-sm text-white">
            Vorschau D3 (2/2) — reine Team-Seite (nicht die Live-Seite)
          </div>
          <p className="mb-10 text-xs uppercase tracking-widest text-stone">Team</p>
          <h1 className="mb-14 max-w-2xl text-4xl font-normal leading-[1.1] tracking-tight text-ink md:text-5xl">
