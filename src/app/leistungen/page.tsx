      ...
      <section className="border-t border-mist py-20 md:pt-28">
        <Container>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            {kompetenzen.map((k) => (
              <div key={k.titel} className="border border-stone/30 bg-mist p-8">
            ...
            <Link
              ...
              className="group flex flex-col justify-between border border-stone/30 bg-mist p-8 transition-colors hover:bg-stone/15"
            >
              <div>
