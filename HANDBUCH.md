...
| **KI-Werkbank (Konzept «Der KI-Architekt»)** | Konzept liegt vor in `konzepte/ki-architekt.md`: eigene Rubrik, in der wir öffentlich prüfen, welche KI-Werkzeuge im Architekturbüro taugen. Offen sind die acht Entscheidungen in Abschnitt 16 des Konzepts (Name der Rubrik, verantwortliche Person, Zeitbudget, Werkzeugliste des Büros, Workshop-Ansatz). Ausserdem sind die Marktzahlen im Konzept nur über Suchergebnisse belegt und vor einer Veröffentlichung an der Originalquelle zu prüfen. | mittel |
