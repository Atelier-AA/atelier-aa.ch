...
| Konzepte und Vorhaben (interne Papiere, nicht auf der Website) | `konzepte/<thema>.md` |
...
| **KI-Werkbank (Konzept «Der KI-Architekt»)** | Konzept liegt vor in `konzepte/ki-architekt.md`: eigene Rubrik, in der wir öffentlich prüfen, welche KI-Werkzeuge im Architekturbüro taugen. Die Grundsatzentscheide sind getroffen (Rubrik «KI-Werkbank», verantwortlich Alisami Aljili, ein Beitrag pro Monat, eigene Seite `/ki-werkbank` mit Werkzeugregister, Workshops nach Aufwand, eigene Schweizer Umfrage ab Monat 4). Offen sind noch: die Liste der Programme und Abos, die das Büro heute nutzt, sowie der Halbtagessatz für Workshops. Ausserdem sind die Marktzahlen im Konzept nur über Suchergebnisse belegt und vor einer Veröffentlichung an der Originalquelle zu prüfen. | mittel |
